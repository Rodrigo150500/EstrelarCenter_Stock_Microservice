...
from .data.update_product_use_case_integration_data import update_product_sucessfully_data, update_product_invalid_body_data
...
def test_update_product_invalid_body(setup_use_case):
    ...
    data = update_product_invalid_body_data()
