...
from .interfaces.update_product_use_case_interface import UpdateProductUseCaseInterface
...
class UpdateProductFirebaseUseCase(UpdateProductUseCaseInterface):
    ...
    def handle(self, http_request: HttpRequest) -> HttpResponse:
        ...
        update_product_validator_request(body)

        body_formatted = self.__body_format(body)

        self.__update_in_database(body, body_formatted)
    ...
    def __update_in_database(self, body: dict, body_formatted: dict) -> None:
